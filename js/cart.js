...
var arr = ['Price', 'Quantity', 'Remove'];
var instrumentsNames = ['Violin', 'Drum', 'Oud', 'Harp', 'Tambourine', 'Trumpet'];
var instrumentsPrices = [1400, 800, 2000, 2500, 750, 1750];
var instrumentsImages = ['violin.png', 'drum.png', 'oud.png', 'harp.png', 'tambourine.png', 'trumpet.png'];
...
for(var i=0; i<3;i++){
  ...
  productCartTable.appendChild(tableHeader);
  ...
  for(i=0; i<instrumentsNames.length; i++){
    ...
    tableColumn3.appendChild(buyNowButton);
